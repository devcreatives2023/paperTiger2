...
const Guiding = () => {
  ...
  return (
    ...
    >
      ...
      <div className=" col-span-1 xl:text-[19px] lg:text-[19px] mt-12 xl:mt-0 lg:mt-0 xl:-ml-[20px] lg:-ml-[20px]">
      ...
      {data.map((items, index) => {
          return (
            <div key={index} className="border-b-2   gap-y-[26px] flex flex-col w-[100%] leading-10">
